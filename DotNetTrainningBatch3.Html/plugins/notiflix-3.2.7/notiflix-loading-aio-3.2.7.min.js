/* Notiflix Loading AIO (https://notiflix.github.io) - Version: 3.2.7 - Author: Furkan (https://github.com/furcan) - Copyright 2019 - 2024 Notiflix, MIT License (https://opensource.org/licenses/MIT) */
...
(function (a, b) {
  ...
  function (a) {
    ...
    var b,
      ...
      p = function (a, b, c) {
        a || (a = "60px"), b || (b = "#f8f8f8"), c || (c = "#32c682");
        var d =
      ...
      r = function (g, q, r, s, u) {
        ...
        if (
          ...
          var w = {};
          "object" == typeof q ? (w = q) : "object" == typeof r && (w = r),
            (b = h(!0, b, w));
        }
        var x = "";
        if (("string" == typeof q && 0 < q.length && (x = q), s)) {
          x =
            x.length > b.messageMaxLength
              ? i(x).toString().substring(0, b.messageMaxLength) + "..."
              : i(x).toString();
          var y = "";
          0 < x.length &&
            (y =
          ...
          var z = "";
          if (g === c.Standard) z = j(b.svgSize, b.svgColor);
            ...
            if (
              g === c.Custom &&
              (null === b.customSvgUrl || null === b.customSvgCode)
            )
              return (
                e(
            ...
            z = p(b.svgSize, "#f8f8f8", "#32c682");
          }
          var A = parseInt((b.svgSize || "").replace(/[^0-9]/g, "")),
            B = a.innerWidth,
            C = A >= B ? B - 40 + "px" : A + "px",
            D =
              '<div style="width:' +
          ...
          if (
            ...
            (E.className =
              ...
              (b.clickToClose ? " nx-loading-click-to-close" : "")),
            (E.style.zIndex = b.zindex),
            (E.style.background = b.backgroundColor),
            (E.style.animationDuration = b.cssAnimationDuration + "ms"),
            (E.style.fontFamily =
              '"' +
              b.fontFamily +
              '", ' +
            ...
            b.rtl &&
              (E.setAttribute("dir", "rtl"), E.classList.add("nx-rtl-on")),
            (E.innerHTML = D + y),
            !a.document.getElementById(E.id) &&
              (a.document.body.appendChild(E), b.clickToClose))
          ) {
            var F = a.document.getElementById(E.id);
            F.addEventListener("click", function () {
              E.classList.add("nx-remove");
              var a = setTimeout(function () {
                null !== E.parentNode &&
                  (E.parentNode.removeChild(E), clearTimeout(a));
              }, b.cssAnimationDuration);
            });
          }
        } else if (a.document.getElementById(d.ID))
          var G = a.document.getElementById(d.ID),
            H = setTimeout(function () {
              G.classList.add("nx-remove");
              var a = setTimeout(function () {
                null !== G.parentNode &&
                  (G.parentNode.removeChild(G), clearTimeout(a));
              }, b.cssAnimationDuration);
              clearTimeout(H);
            }, u);
        b = h(!0, b, v);
      ...
      s = function (c) {
        "string" != typeof c && (c = "");
        var f = a.document.getElementById(d.ID);
        if (f)
          if (0 < c.length) {
            c =
              c.length > b.messageMaxLength
                ? i(c).substring(0, b.messageMaxLength) + "..."
                : i(c);
            var g = f.getElementsByTagName("p")[0];
            if (g) g.innerHTML = c;
            else {
              var h = a.document.createElement("p");
              (h.id = b.messageID),
                (h.className = "nx-loading-message nx-loading-message-new"),
                (h.style.color = b.messageColor),
                (h.style.fontSize = b.messageFontSize),
                (h.innerHTML = c),
                f.appendChild(h);
            }
          } else e("Where is the new message?");
      },
      t = {
        Loading: {
          init: function (a) {
            (b = h(!0, d, a)), g(q, "NotiflixLoadingInternalCSS");
          },
          merge: function (a) {
            return b
              ? void (b = h(!0, b, a))
          ...
          standard: function (a, b) {
            r(c.Standard, a, b, !0, 0);
          },
          hourglass: function (a, b) {
            r(c.Hourglass, a, b, !0, 0);
          },
          circle: function (a, b) {
            r(c.Circle, a, b, !0, 0);
          },
          ...
          notiflix: function (a, b) {
            r(c.Notiflix, a, b, !0, 0);
          },
          remove: function (a) {
            "number" != typeof a && (a = 0), r(null, null, null, !1, a);
          },
          change: function (a) {
            s(a);
          },
    ...
    return "object" == typeof a.Notiflix
      ? h(!0, a.Notiflix, { Loading: t.Loading })
      : { Loading: t.Loading };
  }
);
