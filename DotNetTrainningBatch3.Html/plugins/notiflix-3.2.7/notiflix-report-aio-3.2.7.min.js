/* Notiflix Report AIO (https://notiflix.github.io) - Version: 3.2.7 - Author: Furkan (https://github.com/furcan) - Copyright 2019 - 2024 Notiflix, MIT License (https://opensource.org/licenses/MIT) */
    ...
    var b,
      ...
      o = function (e, g, n, o, q, r) {
        ...
        if (
          ...
          var t = {};
          "object" == typeof q ? (t = q) : "object" == typeof r && (t = r),
            (s = h(!0, b, {})),
            (b = h(!0, b, t));
        }
        var u = b[e.toLocaleLowerCase("en")];
        "string" != typeof g && (g = "Notiflix " + e),
          ...
          n.length > b.messageMaxLength &&
            (n = n.substring(0, b.messageMaxLength) + "..."),
          o.length > b.buttonMaxLength &&
            (o = o.substring(0, b.buttonMaxLength) + "..."),
          b.cssAnimation || (b.cssAnimationDuration = 0);
        var v = a.document.createElement("div");
        (v.id = d.ID),
          (v.className = b.className),
          (v.style.zIndex = b.zindex),
          (v.style.borderRadius = b.borderRadius),
          (v.style.fontFamily =
            '"' +
            b.fontFamily +
            '", ' +
            '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif'),
          b.rtl && (v.setAttribute("dir", "rtl"), v.classList.add("nx-rtl-on")),
        ...
        b.backOverlay &&
          (w =
            ...
            (x ? " nx-report-click-to-close" : "") +
            '" style="background:' +
            (u.backOverlayColor || b.backOverlayColor) +
            ";animation-duration:" +
        ...
        if (
          (e === c.Success
            ? (y = j(b.svgSize, u.svgColor))
            : e === c.Failure
            ? (y = k(b.svgSize, u.svgColor))
            : e === c.Warning
            ? (y = l(b.svgSize, u.svgColor))
            : e === c.Info && (y = m(b.svgSize, u.svgColor)),
          (v.innerHTML =
            w +
            '<div class="' +
            b.className +
            ...
            o +
            "</a></div>"),
          !a.document.getElementById(v.id))
        ) {
          a.document.body.appendChild(v);
          var z = function () {
              var c = a.document.getElementById(v.id);
              c.classList.add("nx-remove");
              var d = setTimeout(function () {
                null !== c.parentNode && c.parentNode.removeChild(c),
                  clearTimeout(d);
              }, b.cssAnimationDuration);
            },
            A = a.document.getElementById("NXReportButton");
          if (
            (A.addEventListener("click", function () {
              "function" == typeof q && q(), z();
            }),
            w && x)
          ) {
            var B = a.document.querySelector(".nx-report-click-to-close");
      ...
      p = {
        Report: {
          init: function (a) {
            (b = h(!0, d, a)), g(n, "NotiflixReportInternalCSS");
          },
          merge: function (a) {
            return b
              ? void (b = h(!0, b, a))
          ...
          success: function (a, b, d, e, f) {
            o(c.Success, a, b, d, e, f);
          },
          failure: function (a, b, d, e, f) {
            o(c.Failure, a, b, d, e, f);
          },
          warning: function (a, b, d, e, f) {
            o(c.Warning, a, b, d, e, f);
          },
          info: function (a, b, d, e, f) {
            o(c.Info, a, b, d, e, f);
          },
        },
      };
    return "object" == typeof a.Notiflix
      ? h(!0, a.Notiflix, { Report: p.Report })
      : { Report: p.Report };
  }
);
