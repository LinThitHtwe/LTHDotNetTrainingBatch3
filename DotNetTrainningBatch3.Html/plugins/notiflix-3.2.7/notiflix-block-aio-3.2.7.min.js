/* Notiflix Block AIO (https://notiflix.github.io) - Version: 3.2.7 - Author: Furkan (https://github.com/furcan) - Copyright 2019 - 2024 Notiflix, MIT License (https://opensource.org/licenses/MIT) */
    ...
    var b,
      ...
      t = function (c, i, r, t, v, w) {
        ...
        if (Array.isArray(r)) {
          ...
          x = r;
        } else if (Object.prototype.isPrototypeOf.call(NodeList.prototype, r)) {
          if (1 > r.length)
            return (
              f(
          ...
          x = Array.prototype.slice.call(r);
        } else {
          var y =
            "string" != typeof r ||
            1 > (r || "").length ||
          ...
          var z = a.document.querySelectorAll(r);
          if (1 > z.length)
            return (
              f(
        ...
        if (
          ...
          var B = {};
          "object" == typeof t ? (B = t) : "object" == typeof v && (B = v),
            (b = j(!0, b, B));
        }
        var C = "";
        "string" == typeof t && 0 < t.length && (C = t),
          b.cssAnimation || (b.cssAnimationDuration = 0);
        var D = e.className;
        "string" == typeof b.className && (D = b.className.trim());
        var E =
            "number" == typeof b.querySelectorLimit
              ? b.querySelectorLimit
              : 200,
          F = (x || []).length >= E ? E : x.length,
          G = "nx-block-temporary-position";
        if (c) {
          for (
            var H,
              I = [
            ...
            if (((H = x[J]), H)) {
              if (-1 < I.indexOf(H.tagName.toLocaleLowerCase("en"))) break;
              var K = H.querySelectorAll("[id^=" + e.ID + "]");
              if (1 > K.length) {
                var L = "";
                i &&
                  (i === d.Hourglass
                    ? (L = m(b.svgSize, b.svgColor))
                    : i === d.Circle
                    ? (L = n(b.svgSize, b.svgColor))
                    : i === d.Arrows
                    ? (L = o(b.svgSize, b.svgColor))
                    : i === d.Dots
                    ? (L = p(b.svgSize, b.svgColor))
                    : i === d.Pulse
                    ? (L = q(b.svgSize, b.svgColor))
                ...
                0 < C.length &&
                  ((C =
                    C.length > b.messageMaxLength
                      ? k(C).substring(0, b.messageMaxLength) + "..."
                      : k(C)),
                  (N =
                ...
                (O.id = e.ID + "-" + s),
                  (O.className =
                    D + (b.cssAnimation ? " nx-with-animation" : "")),
                  (O.style.position = b.position),
                  (O.style.zIndex = b.zindex),
                  (O.style.background = b.backgroundColor),
                  (O.style.animationDuration = b.cssAnimationDuration + "ms"),
                  (O.style.fontFamily =
                    '"' +
                    b.fontFamily +
                    '", ' +
                  ...
                  b.rtl &&
                    (O.setAttribute("dir", "rtl"),
                    O.classList.add("nx-rtl-on")),
                  (O.innerHTML = M + N);
                var P = a.getComputedStyle(H).getPropertyValue("position"),
                  Q =
                    "string" == typeof P
                      ? P.toLocaleLowerCase("en")
                      : "relative",
                  R = Math.round(1.25 * parseInt(b.svgSize)) + 40,
                  S = H.offsetHeight || 0,
                  T = "";
                R > S && (T = "min-height:" + R + "px;");
                var U = "";
                U = H.getAttribute("id")
                  ? "#" + H.getAttribute("id")
                  : H.classList[0]
                  ? "." + H.classList[0]
                  : (H.tagName || "").toLocaleLowerCase("en");
                var V = "",
                  W =
                    -1 >=
                    ["absolute", "relative", "fixed", "sticky"].indexOf(Q);
                if (W || 0 < T.length) {
                  if (!h("head")) return !1;
                  W && (V = "position:relative!important;");
                  var X =
                      '<style id="Style-' +
                      e.ID +
                      "-" +
                      ...
                      T +
                      "}</style>",
                    Y = a.document.createRange();
                  Y.selectNode(a.document.head);
                  var Z = Y.createContextualFragment(X);
                  a.document.head.appendChild(Z), H.classList.add(G);
                }
                H.appendChild(O);
              }
            }
          ...
          var $ = function (c) {
              var d = setTimeout(function () {
                ...
                var b = c.getAttribute("id"),
                  e = a.document.getElementById("Style-" + b);
            ...
            _ = function (a) {
              if (a && 0 < a.length)
                for (var b, c = 0; c < a.length; c++)
                  (b = a[c]), b && (b.classList.add("nx-remove"), $(b));
              else
                "string" == typeof r
                  ? g(
            ...
            aa = function (a) {
              var c = setTimeout(function () {
                a.classList.remove(G), clearTimeout(c);
      ...
      u = {
        Block: {
          init: function (a) {
            (b = j(!0, e, a)), i(r, "NotiflixBlockInternalCSS");
          },
          merge: function (a) {
            return b
              ? void (b = j(!0, b, a))
          ...
          standard: function (a, b, c) {
            t(!0, d.Standard, a, b, c);
          },
          hourglass: function (a, b, c) {
            t(!0, d.Hourglass, a, b, c);
          },
          ...
          pulse: function (a, b, c) {
            t(!0, d.Pulse, a, b, c);
          },
          remove: function (a, b) {
            "number" != typeof b && (b = 0), t(!1, null, a, null, null, b);
          },
        },
      };
    return "object" == typeof a.Notiflix
      ? j(!0, a.Notiflix, { Block: u.Block })
      : { Block: u.Block };
  }
);
