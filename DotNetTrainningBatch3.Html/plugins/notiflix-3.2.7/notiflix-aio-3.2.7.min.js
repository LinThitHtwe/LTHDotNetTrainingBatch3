    ...
    var e,
      ...
      F = function (a, n, o, r) {
        ...
        if (
          ...
          (x.id = m.overlayID),
            ...
            (x.style.right = 0),
            (x.style.bottom = 0),
            (x.style.background = f.backOverlayColor || e.backOverlayColor),
        ...
        if (k) {
          var h,
            ...
            z = function () {
              ...
              e && 0 >= d.childElementCount && e.classList.add("nx-remove"),
                clearTimeout(h);
            },
            S = function () {
              if (
        ...
        if (e.showOnlyTheLastOne && 0 < T)
          for (
            ...
            (I = R[A]), null !== I.parentNode && I.parentNode.removeChild(I);
        e = v(!0, e, c);
      },
      E = function () {
      ...
      j = function (e, a, n, o, r, l) {
        ...
        (x.id = p.ID),
          ...
          i.rtl && (x.setAttribute("dir", "rtl"), x.classList.add("nx-rtl-on")),
      ...
      H = function (e, i, n, o, r, l, m, c, p) {
        ...
        "object" != typeof p || Array.isArray(p) || (a = v(!0, a, p)),
          ...
          a.plainText && ((i = N(i)), (n = N(n)), (r = N(r)), (l = N(l))),
          a.plainText ||
        ...
        (g.id = d.ID),
          ...
          a.rtl && (g.setAttribute("dir", "rtl"), g.classList.add("nx-rtl-on"));
            ...
            if (((S = m[X]), S)) {
              ...
              if (1 > D.length) {
                ...
                (j.id = u.ID + "-" + Q),
                  ...
                  (j.style.animationDuration = o.cssAnimationDuration + "ms"),
                ...
                var Y = "",
                  K =
                    -1 >=
                    ["absolute", "relative", "fixed", "sticky"].indexOf(H);
                if (K || 0 < V.length) {
                  if (!w("head")) return !1;
